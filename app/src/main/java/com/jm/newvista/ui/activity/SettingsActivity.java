...
import com.jm.newvista.ui.base.BasePreferenceActivity;
 ...
 */
public class SettingsActivity extends BasePreferenceActivity<SettingsModel, SettingsView, SettingsPresenter>
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
            if (preference.getKey().equals(getString(R.string.clear_cache))) {
                Intent intent = new Intent(ApplicationUtil.context, ClearCacheActivity.class);
