...
public class NetworkUtil {
    ...
    public static final String LOG_IN_URL = "http://192.168.123.217/servlet.customer.LogIn";
    public static final String USER_INFO_URL = "http://192.168.123.217/servlet.customer.GetUserInfo";
    public static final String SECONDARY_LOGON_URL = "http://192.168.123.217/servlet.customer.SecondaryLogon";
