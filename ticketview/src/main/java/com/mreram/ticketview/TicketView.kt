...
/**
 * Created by Mohammad Reza Eram on 2/23/18. Modified by Johnny Miller on 3/8/2018.
 */
...
class TicketView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        try {
            ...
            dashColor = a.getColor(R.styleable.TicketView_tv_dashColor, Color.parseColor("#2962ff"))
